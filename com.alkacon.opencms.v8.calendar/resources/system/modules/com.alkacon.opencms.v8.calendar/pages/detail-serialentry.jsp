<%@ page session="false" import="com.alkacon.opencms.v8.calendar.*" %>
...
<jsp:useBean id="bean" class="com.alkacon.opencms.v8.calendar.CmsSerialDateContentBean" scope="request"><%
