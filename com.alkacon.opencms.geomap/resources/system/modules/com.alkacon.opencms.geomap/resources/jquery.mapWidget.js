(function($) {
    ...
    * @version 0.9
    */
   $.fn.AlkaconGeoMapMap = function(/**AsocArray*/options) /**jQuery*/ {
   
      // compute options before element iteration
      var /**AsocArray*/ config = $.extend({}, $.fn.AlkaconGeoMapMap.defaults, options ||
      {});
      ...
      return this.each(function() {
         ...
         $container.AlkaconGeoMapIdentify({
            prefix: baseId + '-',
            rules: [{
               find: 'label',
               attr: 'for'
         ...
         $address.bind('blur keydown', onReturnOrBlur(function() {
            ...
            geocoder.geocode({'address': address}, function(results, status) {
               ...
               // show the list
               $span.AlkaconGeoMapSuggest(data, opts);
               // style managing
         ...
         // style check boxes
         $allow.AlkaconGeoMapToggleBar();
         // style input text boxes
         $container.find('input[type=text]').AlkaconGeoMapInput();
         // style radio buttons
         $container.find('input[type=radio]').AlkaconGeoMapRadio();
         
         // enable option panel expander
         $container.find('a.collapsible').AlkaconGeoMapCollapsible({
   ...
   $(document).ready(function() {
      $('input[type=hidden].map-widget').each(function() {
         $(this).parent('div').AlkaconGeoMapMap({
