 ...
 * @version 0.9
 */ 
$.fn.AlkaconGeoMapIdentify = function(/**AsocArray*/options) /**jQuery*/ {

  // compute options before element iteration
  var /**AsocArray*/config = $.extend(true, {}, $.fn.AlkaconGeoMapIdentify.defaults, options || {});
 ...
 */
$.fn.AlkaconGeoMapIdentify.defaults = {
  prefix  : /** String */ '',
  postfix : /** String */ '',
 ...
 */ 
$.fn.AlkaconGeoMapCollapsible = function(/**AsocArray*/options) /**jQuery*/ {

  // compute options before element iteration
  var /**AsocArray*/config = $.extend(true, {}, $.fn.AlkaconGeoMapCollapsible.defaults, options || {});
 ...
 */
$.fn.AlkaconGeoMapCollapsible.defaults = {
  lessText  : /** String */ 'Less',
  lessClass : /** String */ 'AlkaconGeoMap-collapse-less',
  lessIcon  : /** String */ 'ui-icon-triangle-1-s',
  moreText  : /** String */ 'More',
  moreClass : /** String */ 'AlkaconGeoMap-collapse-more',
 ...
 * @version 0.9
 */ 
$.fn.AlkaconGeoMapInput = function(/**AsocArray*/options) /**jQuery*/{

  // compute options before element iteration
  var /**AsocArray*/config = $.extend(true, {}, $.fn.AlkaconGeoMapInput.defaults, options || {});
 ...
 */
$.fn.AlkaconGeoMapInput.defaults = {
  disabledClass: /**String*/ 'ui-state-disabled',
  hoverClass   : /**String*/ 'ui-state-hover',
  focusClass   : /**String*/ 'ui-state-focus',
  className    : /**String*/ 'AlkaconGeoMap-input' // set the padding-left and right to the border-radius of your theme
};
 ...
 * @TODO: width handling
 */ 
$.fn.AlkaconGeoMapSelect = function(/**AsocArray*/options) /**jQuery*/ {

  // compute options before element iteration
  var /**AsocArray*/config = $.extend(true, {}, $.fn.AlkaconGeoMapSelect.defaults, options || {});
  ...
  return this.each(function(i) {
    ...
    $newSel  
      .addClass('fg-button AlkaconGeoMap-select fg-button-icon-right ui-widget ui-corner-all ui-state-default')
      .addClass(opts.className);
 ...
 */
$.fn.AlkaconGeoMapSelect.defaults = {
  title: false, // no title
  disabledClass: 'ui-state-disabled',
  hoverClass: 'ui-state-hover',
  focusClass: 'ui-state-focus',
  className: 'AlkaconGeoMap-select' // set the padding-left and right to the border-radius of your theme
};
 ...
 * @version 0.9
 */ 
$.fn.AlkaconGeoMapRadio = function(/**AsocArray*/options) /**jQuery*/ {

  // compute options before element iteration
  var /**AsocArray*/opts = $.extend(true, {}, $.fn.AlkaconGeoMapRadio.defaults, options || {});
 ...
 * className: The class name to use for the wrapping span
 */
$.fn.AlkaconGeoMapRadio.defaults = {
  activeClass: 'ui-state-active',
  disabledClass: 'ui-state-disabled',
  hoverClass: 'ui-state-hover',
  focusClass: 'ui-state-focus',
  className: 'AlkaconGeoMap-radio' 
};
 ...
 * @version 0.9
 */ 
$.fn.AlkaconGeoMapToggleBar = function(/**AsocArray*/options) /**jQuery*/ {

  // compute options before element iteration
  var /**AsocArray*/opts = $.extend(true, {}, $.fn.AlkaconGeoMapToggleBar.defaults, options || {});
 ...
 * className: The class name to use for the wrapping span
 */
$.fn.AlkaconGeoMapToggleBar.defaults = {
  activeClass: 'ui-state-active',
  disabledClass: 'ui-state-disabled',
  hoverClass: 'ui-state-hover',
  focusClass: 'ui-state-focus',
  className: 'AlkaconGeoMap-check' 
};
 ...
 */ 
$.fn.AlkaconGeoMapSuggest = function(/**Array*/data, /**AsocArray*/options) /**jQuery*/ {

  // compute options before element iteration
  var /**AsocArray*/config = $.extend(true, {}, $.fn.AlkaconGeoMapSuggest.defaults, options || {});
 ...
 */
$.fn.AlkaconGeoMapSuggest.defaults = {
  flyOut: true,
  width: '',
  startOpen: true,
