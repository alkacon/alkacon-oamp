/*
 * File   : $Source: /alkacon/cvs/alkacon/com.alkacon.opencms.v8.usagereport/src/com/alkacon/opencms/v8/usagereport/CmsUpdatefeed.java,v $
...
import com.alkacon.opencms.v8.feeder.Messages;
...
/**
 * Creates a syndication feed based on a XML content that uses the AlkaconV8Updatefeed schema XSD.<p>
 * 
 * The main-class is CmsUpdateFeed it creates a syndication feed based on the XML content that uses
 * the AlkaconV8Updatefeed schema XSD. The classes named CmsUpdateFeedConfig... are Beans which help 
...
public class CmsUpdatefeed {
    ...
    public static final String NODE_SCHEMA = "AlkaconV8Updatefeeds";
    ...
    /** The module name. */
    private static final String MODULE_NAME = "com.alkacon.opencms.v8.usagereport";
    ...
    public void processResources(int timeFrame) throws CmsException {
        ...
        Collections.sort(
            resources,
            new CmsDateResourceComparator(m_myCms, Arrays.asList(new String[] {"dateLastModified"}), false));
