/*
 * File   : $Source: /alkacon/cvs/alkacon/com.alkacon.opencms.calendar/src/com/alkacon/opencms/calendar/test/TestCalendarDisplay.java,v $
...
import com.alkacon.opencms.calendar.CmsCalendarMonthBean;
...
public class TestCalendarDisplay extends OpenCmsTestCase {
    ...
    public void testDailyView() throws Exception {
        ...
        CmsCalendarEntryDate viewDate = new CmsCalendarEntryDate(new GregorianCalendar(2005, 7, 1, 0, 0, 0), new GregorianCalendar(2005, 7, 31, 23, 59, 59));        
        ...
        Map days = displayCalendar.getEntriesForDays(new GregorianCalendar(2005, 7, 1, 0, 0, 0), new GregorianCalendar(2005, 7, 31, 23, 59, 59));
