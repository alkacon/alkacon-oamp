/*
 * File   : $Source: /alkacon/cvs/alkacon/com.alkacon.opencms.calendar/src/com/alkacon/opencms/calendar/test/TestCalendarSerialDateProperties.java,v $
...
import com.alkacon.opencms.calendar.CmsCalendarDisplay;
import com.alkacon.opencms.calendar.CmsCalendarEntryDateSerial;
import com.alkacon.opencms.calendar.CmsCalendarSerialDateFactory;
...
public class TestCalendarSerialDateProperties extends OpenCmsTestCase {
    ...
    public static void readSerialDateFromProperty(
        ...
        CmsCalendarEntryDateSerial serialDate = CmsCalendarSerialDateFactory.getSerialDate(property.getValueMap(), locale);
        ...
        CmsProperty property2 = cms.readPropertyObject(
            resource1,
            CmsCalendarDisplay.PROPERTY_CALENDAR_STARTDATE,
            false);
