...
The Alkacon OpenCms ExcelImport module and these instructions are distributed
...
With the ExcelImport module, it is possible to upload an excel file to OpenCms 
and to create XML contents from one OpenCms resource type, one XML content per 
one excel record.
...
PDF file "Alkacon_OAMP_ExcelImport.pdf".
