/*
 * File   : $Source: /alkacon/cvs/alkacon/com.alkacon.opencms.excelimport/src/com/alkacon/opencms/excelimport/CmsExcelXmlConfiguration.java,v $
...
public class CmsExcelXmlConfiguration {
    ...
    public void readConfigurationFile(CmsObject cmsObject, String fileName) {
        ...
        try {
            ...
            if (!localeFound) {
                locale = (Locale)xmlContent.getLocales().get(0);
            }
