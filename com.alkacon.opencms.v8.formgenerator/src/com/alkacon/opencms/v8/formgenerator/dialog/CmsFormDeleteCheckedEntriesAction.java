/*
 * File   : $Source: /alkacon/cvs/alkacon/com.alkacon.opencms.v8.formgenerator/src/com/alkacon/opencms/v8/formgenerator/dialog/CmsFormDeleteCheckedEntriesAction.java,v $
...
public class CmsFormDeleteCheckedEntriesAction extends CmsListMultiAction {
    ...
    public String getIconPath() {
        ...
        if (!isEditable()) {
            return "tools/database/buttons/v8-webform_delete_disabled.png";
        }
