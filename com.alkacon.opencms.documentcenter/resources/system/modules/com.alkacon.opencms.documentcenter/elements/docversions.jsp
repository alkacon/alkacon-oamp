<%@ page
	import="org.opencms.util.*,javax.servlet.jsp.*,org.opencms.file.*,org.opencms.jsp.*,org.opencms.i18n.CmsMessages,org.opencms.file.history.*,org.opencms.site.*,java.util.*,com.alkacon.opencms.documentcenter.*,org.opencms.file.history.*"
	buffer="none"%>
<%
    // initialise Cms Action Element
			...
			CmsMessages messages = cms.getMessages(
					"com.alkacon.opencms.documentcenter.messages_documents",
					locale);
...
<form>&nbsp;&nbsp;<input type="button" class="button-w"
	value="<%=messages.key("link.back")%>" onclick=h
	istory.back();;;
