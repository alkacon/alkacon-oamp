	...
	<% } else { %>
	    <tr>
	      ...
	      <td valign="top">
			...
			<img src="<%=cms.link("/system/modules/com.alkacon.opencms.documentcenter/resources/calendar.png")%>" id="triggercalendarfrom" border="0" title="<%= messages.key("newdocuments.calendar.title") %>" alt="<%= messages.key("newdocuments.calendar.alt") %>"/>
	      </td>
	    </tr>
	    <tr>
	      ...
	      <td valign="top">
			...
			<img src="<%=cms.link("/system/modules/com.alkacon.opencms.documentcenter/resources/calendar.png")%>" id="triggercalendarto" border="0" title="<%= messages.key("newdocuments.calendar.title") %>" alt="<%= messages.key("newdocuments.calendar.alt") %>"/>
	      </td>
	    </tr>
	<% } %>
    <tr>
