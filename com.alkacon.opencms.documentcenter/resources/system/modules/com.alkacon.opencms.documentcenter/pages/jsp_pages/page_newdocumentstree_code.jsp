...
if ("redirect_a".equalsIgnoreCase(paramRedirect)) {
 ...
 %><link	type="text/css" rel="stylesheet" href="<cms:link>/system/modules/com.alkacon.opencms.documentcenter/resources/documents.css</cms:link>" /><%
 ...
 %><link	type="text/css" rel="stylesheet" href="<cms:link>/system/modules/com.alkacon.opencms.documentcenter/resources/documents.css</cms:link>" /><%
	out.println("<div class=\"download_onecol\">");%>
	<%@ include file="%(link.strong:/system/modules/com.alkacon.opencms.documentcenter/pages/jsp_pages/page_newdocumentstree_code_searchForm.jsp:f8e2cbb2-4acc-11de-9a1a-03821fc5d684)" %>
	<% out.println("</div>");
 // include the template foot
 cms.include(template, "foot");
}
