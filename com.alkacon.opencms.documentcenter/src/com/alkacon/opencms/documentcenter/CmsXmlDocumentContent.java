...
public class CmsXmlDocumentContent {
    ...
    private static final int XMLDOCUMENT_TYPE = 261;
    ...
    public String getDisclaimer() {
        ...
        String path = m_cms.property(PROPERTY_DISCLAIMER_PAGE, "search", null);
        if (path == null) {
            return null;
        }
     ...
     */
    private String getContentElement(List paths, String elementName) {

        Iterator iter = paths.iterator();
        while (iter.hasNext()) {
            String actPath = (String)iter.next();
    ...
    private String getContentElement(String property, String elementName, boolean search) {
        ...
        List paths = getFolderList(property, search);
    ...
    private String getContentElement(String property, String elementName, boolean search, String searchRoot) {
        ...
        List paths = getFolderList(property, search, searchRoot);
        return getContentElement(paths, elementName);
    }
     ...
     */
    private List getFolderList(String property, boolean search) {

        return getFolderList(property, search, m_cms.getRequestContext().getFolderUri());
    }
     ...
     * @return a list with all found paths to look for a default file
     */
    private List getFolderList(String property, boolean search, String searchRoot) {
