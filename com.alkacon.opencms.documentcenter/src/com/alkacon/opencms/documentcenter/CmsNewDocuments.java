...
public final class CmsNewDocuments {
     ...
     */
    public static String buildCategoryList(List categories, String attributes) {
     ...
     */
    public static List filterLinkedResources(List resources) {

        List filteredResources = new ArrayList();
        Set addedResources = new HashSet();
    ...
    public static String getCategories(CmsObject cms, HttpServletRequest request, String messageAll) {
        ...
        if ("true".equals(paramAll)) {
            ...
            List categories = getCategoryList(request.getParameter("categorylist"));
            Iterator i = categories.iterator();
            while (i.hasNext()) {
     ...
     */
    public static List getCategoryList(String allCategories) {
     ...
     */
    private static List getNewResourceList(
        CmsObject cms,
        String site,
        long startDate,
        long endDate,
        List categoryFolders) {
        ...
        if (categoryFolders.size() == 0) {
            ...
            Iterator i = allResources.iterator();
            while (i.hasNext()) {
                CmsResource curResource = (CmsResource)i.next();
                boolean add = false;
