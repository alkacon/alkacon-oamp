<%@ page session="false" import="org.opencms.jsp.*, com.alkacon.opencms.v8.registration.*" %><%--
--%><%@ taglib prefix="cms" uri="http://www.opencms.org/taglib/cms" %><%--
--%><jsp:useBean id="regInfo" class="com.alkacon.opencms.v8.registration.CmsRegistrationInfo" scope="page" /><%--
