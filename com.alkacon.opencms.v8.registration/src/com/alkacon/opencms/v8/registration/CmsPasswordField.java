/*
 * File   : $Source: /alkacon/cvs/alkacon/com.alkacon.opencms.v8.registration/src/com/alkacon/opencms/v8/registration/CmsPasswordField.java,v $
...
import com.alkacon.opencms.v8.formgenerator.A_CmsField;
...
public class CmsPasswordField extends A_CmsField {
    ...
    public String buildHtml(
        ...
        if (!formHandler.getCmsObject().getRequestContext().currentUser().isGuestUser()) {
            ...
            com.alkacon.opencms.v8.formgenerator.CmsPasswordField pwField = new com.alkacon.opencms.v8.formgenerator.CmsPasswordField();
            ...
            StringTemplate sTemplate = formHandler.getOutputTemplate("field_"
                + com.alkacon.opencms.v8.formgenerator.CmsPasswordField.getStaticType());
        ...
        pwField = new com.alkacon.opencms.v8.formgenerator.CmsPasswordField();
    ...
    /**
     * @see com.alkacon.opencms.v8.formgenerator.A_CmsField#validate(com.alkacon.opencms.v8.formgenerator.CmsFormHandler)
     */
    @Override
