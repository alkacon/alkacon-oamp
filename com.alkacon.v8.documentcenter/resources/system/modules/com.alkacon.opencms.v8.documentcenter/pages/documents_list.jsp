<%@ page session="false" buffer="none"
	import="java.util.*,org.opencms.jsp.*,org.opencms.util.*,com.alkacon.opencms.v8.documentcenter.*"%><%--
...
%><link type="text/css" rel="stylesheet"
	href="<cms:link>/system/modules/com.alkacon.opencms.v8.documentcenter/resources/documents.css</cms:link>" />
<%
