...
if (!request.isRequestedSessionIdFromCookie()) {
	response.sendRedirect( cms.link( "/system/modules/com.alkacon.opencms.v8.documentcenter/pages/jsp_pages/page_disclaimer_check_cookies.jsp?file="
	                                 +curResource ) );
}
...
if (paramAction == null || "".equals(paramAction) || messages.key("disclaimer.decline").equals(paramAction)) { 
  // show the disclaimer form
	...
	<%@ include file="%(link.strong:/system/modules/com.alkacon.opencms.v8.documentcenter/pages/jsp_pages/page_disclaimer_code_showDisclaimer.jsp:c810e3b3-4b6a-11de-a99c-03821fc5d684)" %>
