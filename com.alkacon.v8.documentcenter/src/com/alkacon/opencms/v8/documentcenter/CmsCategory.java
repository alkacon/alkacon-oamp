...
public class CmsCategory implements Comparable<CmsCategory> {
    ...
    private List<CmsCategory> m_subCategories;
    ...
    public int compareTo(CmsCategory obj) {
        ...
        try {
            ...
            return new Integer(getPosition()).compareTo(new Integer(obj.getPosition()));
        } catch (Exception e) {
            // ignore, return 0
        }
        return 0;
     ...
     */
    public List<CmsCategory> getSubCategories() {
    ...
    public List<CmsCategory> getSubCategory(String mainCategory) {
        ...
        List<CmsCategory> subCat = new ArrayList<CmsCategory>();

        Iterator<CmsCategory> i = getSubCategories().iterator();
        while (i.hasNext()) {
    ...
    public void init(CmsObject cms, String folderUri, String propertyName) {
        ...
        List<CmsCategory> mainCat = new ArrayList<CmsCategory>();
        List<CmsCategory> subCat = new ArrayList<CmsCategory>();
     ...
     */
    public void setSubCategories(List<CmsCategory> list) {
