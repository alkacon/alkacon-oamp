<%@page buffer="none" session="false" import="org.opencms.jsp.*, ch.corner.card.frontend.form.*, java.util.*" %><%
...
<%
List<I_CmsField> resultList = formHandler.getFormConfiguration().getFields();
