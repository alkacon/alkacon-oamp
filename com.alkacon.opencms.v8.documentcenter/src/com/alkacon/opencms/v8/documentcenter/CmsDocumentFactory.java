...
public final class CmsDocumentFactory {
    ...
    /** Property name of the document center start folder marker. */
    public static final String PROPERTY_DOCCENTER_STARTFOLDER = "docs.startfolder";

    /**
     * A comparator for the creation date of 2 documents ascending.<p>
     */
    protected static final Comparator<CmsDocument> COMPARE_DATECREATED_ASC = new Comparator<CmsDocument>() {
     ...
     */
    protected static final Comparator<CmsDocument> COMPARE_DATECREATED_DESC = new Comparator<CmsDocument>() {
     ...
     */
    protected static final Comparator<CmsDocument> COMPARE_DATEMODIFIED_ASC = new Comparator<CmsDocument>() {
     ...
     */
    protected static final Comparator<CmsDocument> COMPARE_DATEMODIFIED_DESC = new Comparator<CmsDocument>() {
     ...
     */
    protected static final Comparator<CmsDocument> COMPARE_ID_ASC = new Comparator<CmsDocument>() {
     ...
     */
    protected static final Comparator<CmsDocument> COMPARE_ID_DESC = new Comparator<CmsDocument>() {
     ...
     */
    protected static final Comparator<CmsDocument> COMPARE_POSTFIX_ASC = new Comparator<CmsDocument>() {
     ...
     */
    protected static final Comparator<CmsDocument> COMPARE_POSTFIX_DESC = new Comparator<CmsDocument>() {
     ...
     */
    protected static final Comparator<CmsDocument> COMPARE_SIZE_ASC = new Comparator<CmsDocument>() {
     ...
     */
    protected static final Comparator<CmsDocument> COMPARE_SIZE_DESC = new Comparator<CmsDocument>() {
     ...
     */
    protected static final Comparator<CmsDocument> COMPARE_SORTORDER_ASC = new Comparator<CmsDocument>() {
     ...
     */
    protected static final Comparator<CmsDocument> COMPARE_SORTORDER_DESC = new Comparator<CmsDocument>() {
     ...
     */
    protected static final Comparator<CmsDocument> COMPARE_TITLE_ASC = new Comparator<CmsDocument>() {
     ...
     */
    protected static final Comparator<CmsDocument> COMPARE_TITLE_DESC = new Comparator<CmsDocument>() {
    ...
    protected static final List<String> SORT_METHODS_LIST = Arrays.asList(SORT_METHODS);
    ...
    protected static final List<String> VFS_IGNORED_FILES_LIST = Arrays.asList(VFS_IGNORED_FILES);
    ...
    public static CmsDocument createDocument(
        ...
        String showDocumentValue = allProperties.get(CmsDocument.PROPERTY_SHOWDOCUMENT);
        ...
        if (CmsStringUtil.isEmptyOrWhitespaceOnly(title)) {
            title = allProperties.get(CmsPropertyDefinition.PROPERTY_TITLE);
        }
        ...
        String sortOrder = allProperties.get(CmsDocument.PROPERTY_SORTORDER);
        ...
        if (CmsStringUtil.isNotEmpty(dateCreated)) {
            ...
            try {
                ...
                creationDate = CmsCalendarWidget.getCalendarDate(
                    org.opencms.workplace.Messages.get().getBundle(new Locale("de")),
                    dateCreated,
                    false);
                ...
                try {
                    creationDate = CmsCalendarWidget.getCalendarDate(
                        org.opencms.workplace.Messages.get().getBundle(new Locale("en")),
                        dateCreated,
                        false);
    ...
    public static CmsDocument createDocumentWithVersions(CmsDocumentFrontend jsp, String resourceName) {
        ...
        List<CmsDocument> result = new CmsDocumentList(
            jsp.isUseTypes(),
            jsp.getDefaultType(),
        ...
        try {
            ...
            List<CmsResource> files = cms.getFilesInFolder(CmsResource.getFolderPath(resourceName));
            if (files.contains(res)) {
                // remove the original file from the list of found files
                files.remove(res);
            }
            Iterator<CmsResource> i = files.iterator();
            while (i.hasNext()) {
     ...
     */
    public static List<CmsDocument> getDocumentsForFolder(
        CmsDocumentFrontend jsp,
        String folder,
        String sortMethodProperty) {
        ...
        try {
            ...
            List<CmsResource> subfolders = cms.getSubFolders(folder);
            // get all files in the folder from the VFS
            List<CmsResource> files = cms.getFilesInFolder(folder);

            List<CmsDocument> documentList = new ArrayList<CmsDocument>(files.size() + subfolders.size());
        ...
        return new ArrayList<CmsDocument>(0);
    }

    /**
     * Returns the substituted link for the given resource in the document center.<p>
     * 
     * @param jsp the current action element
     * @param resource the resource to get the link for
     * 
     * @return the substituted link
     */
    public static String getLink(CmsJspActionElement jsp, CmsResource resource) {

        return getLink(jsp, jsp.getRequestContext().removeSiteRoot(resource.getRootPath()));
    }

    /**
     * Returns the substituted link for the given resource path in the document center.<p>
     * 
     * @param jsp the current action element
     * @param resourcePath the path to get the link for
     * 
     * @return the substituted link
     */
    public static String getLink(CmsJspActionElement jsp, String resourcePath) {

        String result = CmsFileUtil.removeTrailingSeparator(jsp.getRequestContext().getFolderUri());
        String docCenterStartFolder = "";

        docCenterStartFolder = (String)jsp.getRequest().getAttribute(CmsDocumentFrontend.ATTR_STARTPATH);

        if ((docCenterStartFolder != null) && resourcePath.startsWith(docCenterStartFolder)) {
            resourcePath = resourcePath.substring(docCenterStartFolder.length());
        }
        result = OpenCms.getLinkManager().substituteLink(jsp.getCmsObject(), result + resourcePath);
        return result;
    }
     ...
     */
    public static List<CmsDocument> getSortedDocuments(
        CmsDocumentFrontend jsp,
    ...
    public static List<CmsDocument> getSortedDocuments(
        ...
        Iterator<CmsResource> allResources = resources.iterator();
        List<CmsDocument> documentList = new CmsDocumentList(
            jsp.isUseTypes(),
            jsp.getDefaultType(),
            jsp.isUseAttachments(),
            jsp.isUseLanguages(),
        ...
        while (allResources.hasNext()) {
            CmsResource currentResource = allResources.next();
        ...
        if (documentList.size() > 1) {
            ...
            Comparator<CmsDocument> comp = getSortComparator(sortMethod, sortDirection);
     ...
     */
    protected static Comparator<CmsDocument> getSortComparator(String sortMethod, String sortDirection) {
     ...
     */
    protected static CmsDocument getSortDocument(CmsDocument o) {

        return o.getDocumentForCurrentLocale();
    }
    ...
    protected static boolean isIgnoredDocument(String resourcePath, boolean completePathForIgnored) {
        ...
        Iterator<String> i = VFS_IGNORED_FILES_LIST.iterator();
        String resourceName = "";
