/*
 * File   : $Source: /alkacon/cvs/alkacon/com.alkacon.opencms.v8.newsletter/src/com/alkacon/opencms/v8/newsletter/admin/CmsMailinglistsList.java,v $
...
public class CmsMailinglistsList extends A_CmsGroupsList {
    ...
    protected void setColumns(CmsListMetadata metadata) {
        ...
        sendAction.setIconPath(PATH_BUTTONS + "v8-newsletter_send.png");
        ...
        usersAction.setIconPath(PATH_BUTTONS + "v8-subscriber.png");
    ...
    protected void setEditAction(CmsListColumnDefinition editCol) {
        ...
        editAction.setIconPath(PATH_BUTTONS + "v8-mailinglist.png");
