/*
 * File   : $Source: /alkacon/cvs/alkacon/com.alkacon.opencms.v8.newsletter/src/com/alkacon/opencms/v8/newsletter/admin/CmsNewsletterList.java,v $
...
public class CmsNewsletterList extends A_CmsListExplorerDialog {
    ...
    public void executeListSingleActions() throws IOException, ServletException {
        ...
        if (getParamListAction().equals(LIST_ACTION_EDIT)) {
            ...
            getToolManager().jspForwardPage(this, "/system/workplace/admin/v8-newsletter/edit.jsp", params);
        } else {
            throwListUnsupportedActionException();
        }
    }
