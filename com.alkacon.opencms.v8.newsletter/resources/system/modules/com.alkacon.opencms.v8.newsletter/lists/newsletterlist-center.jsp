...
<c:choose>
	...
	<c:otherwise>
		<c:set var="folder" value="${cms.subSitePath}.content/v8-newsletter/" />
	</c:otherwise>
</c:choose>
...
<cms:include file="%(link.weak:/system/modules/com.alkacon.opencms.v8.commons/elements/list-paging-base.jsp)">
	<cms:param name="singlepagepath">%(link.weak:/system/modules/com.alkacon.opencms.v8.newsletter/lists/newsletterlist-center-singlepage.jsp)</cms:param>
	...
	<cms:param name="collectorparam">${folder}|alkacon-v8-newsletter|${allcount}|${sentonly}|false</cms:param>
</cms:include>