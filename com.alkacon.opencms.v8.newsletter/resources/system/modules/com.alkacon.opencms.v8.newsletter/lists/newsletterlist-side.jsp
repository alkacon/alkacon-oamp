...
<cms:contentload collector="allNewslettersInFolder" param="%(pageContext.folder)|alkacon-v8-newsletter|%(pageContext.count)|%(pageContext.sentonly)|false" preload="true" >		
