<%@ page session="false" import="com.alkacon.opencms.v8.newsletter.*, org.opencms.util.*" %><%
...
if (CmsStringUtil.isNotEmpty(template)) {
	...
	out.print("</title>\n<style type=\"text/css\">\n");
	out.print(cms.getContent("/system/modules/com.alkacon.opencms.v8.newsletter/resources/style.css"));
	out.print("</style>\n</head>\n<body>");
}
...
case CmsNewsletterSubscriptionBean.ACTION_SUBSCRIBE:
	...
	if (!cms.isConfirmationEnabled() && cms.isShowSendLastNewsletter()) { %>
		<%@include file="%(link.strong:/system/modules/com.alkacon.opencms.v8.newsletter/pages/includes/form-sendlast.jsp)" %>
	<%}
	%></p><%
break;
